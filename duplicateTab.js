...
(function ($) {
    $.fn.DuplicateWindow = function () {
        ...
        window.onload = function () {
            alert("On Load");
            //var isDuplicateWindow = TestIfDuplicate();
            //alert("isDuplicateWindow:   " + isDuplicateWindow);

            if (TestIfDuplicate() == false) {
                SetItem(ItemType.Local, "");
                alert("Duplicate: false");                
              
            } else {
                alert("Duplicate: true");
                window.location.href = "http://localhost/EServiceIFALogon/logon.asp?Error=NOCOOKIE"
            }
        }
